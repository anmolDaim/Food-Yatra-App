...
import com.example.foodyatraapp.Adapter.NotificationAdapter
import com.example.foodyatraapp.R
import com.example.foodyatraapp.databinding.FragmentMenuBottomSheetBinding
import com.example.foodyatraapp.databinding.FragmentNotificationBottomBinding
...
class NotificationBottomFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val notification= listOf("Your order has been cancelled seccessfully","Order has been taken by the driver","" +
                "Congrats your Placed")
